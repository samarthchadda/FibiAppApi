...
router.get('/all-client-appointments/:clientPhone',appointController.getAllClientAppointments);
...
router.get('/all-saloon-appointments/:saloonId',appointController.getAppointsBySaloonId);
