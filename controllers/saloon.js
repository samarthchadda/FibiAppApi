...
exports.getDiffSaloon=(req,res,next)=>{
    ...
    var today1 = new Date();
var startDay1 = 0; 
var weekStart1 = new Date(today1.getDate() - (7 + today1.getDay() - startDay1) % 7);
var weekEnd1 = new Date(today1.getDate() + (7 - today1.getDay() - startDay1) % 7);
console.log(weekStart1,weekEnd1)
